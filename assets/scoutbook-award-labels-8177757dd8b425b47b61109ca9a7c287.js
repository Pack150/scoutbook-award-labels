...
var o=Ember.Application.extend({modulePrefix:n.default.modulePrefix,podModulePrefix:n.default.podModulePrefix,Resolver:a.default});(0,t.default)(o,n.default.modulePrefix)
var r=o
e.default=r}),define("scoutbook-award-labels/controllers/application",["exports","papaparse","jspdf","ember-debug-logger"],function(e,a,t,n){function o(e,a,t,n,o){for(var r=Math.round(a/n*100)/100,l=Math.round(t/o*100)/100,i=1;i<n;i++){var s=r*i
e.line(s,0,s,t)}for(var d=1;d<o;d++){var u=l*d
e.line(0,u,a,u)}}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var r=Ember.Controller.extend({debug:(0,n.default)(),awardData:!1,printPreview:!1,scoutCount:0,makePDF:function(){var e=this,a=new t("portrait","pt","letter")
a.setFont("helvetica")
var n=this.scoutCount,r=0
o(a,612,791,4,3)
var l=function(t){var l=function(l){var i,s,d=0,u=r,c=0
u>=12&&(u%=12),u>=4&&(c=Math.floor(u/4)),s=u%4,i=Math.round(153*s*100)/100,d=Math.round(791/3*c*100)/100,d+=25,e.debug("".concat(c,", ").concat(d," : ").concat(s,",").concat(i," : ").concat(u," : ").concat(l)),a.setLineHeightFactor(1.4),a.setFontSize(9),a.setFontStyle("italic"),d+=12.6,a.text(t,i+113+20,d,{align:"right"}),a.setFontStyle("normal"),a.setFontSize(14),d+=14*1.4
var f=a.splitTextToSize(l,113)
a.text(f,i+20,d),f.length>1&&(d+=14*1.4),d+=2,a.line(i,d,i+153,d),d+=5,a.setFontSize(12),d+=12*1.4
var p=[];["adventures","awards","ranks"].forEach(function(n){if(0!==e.awardData[t][l][n].length){switch(n){case"adventures":p.push("Adventures:")
break
case"awards":p.push("Awards:")
break
default:p.push("Rank:")}e.awardData[t][l][n].forEach(function(e){var t="    - "+e,n=a.splitTextToSize(t,113)
p.push(n[0]),n[1]&&p.push("       "+n[1])}),p.push(" ")}}),a.text(p,i+20,d),++r<n&&r%12==0&&(e.debug("adding a new page"),a.addPage("letter","p"),o(a,612,791,4,3))}
...
e.data.forEach(function(e){if(void 0!==e["Item Name"]){var t="".concat(e["Den Type"]," Den ").concat(e["Den Number"]),o="".concat(e["First Name"]," ").concat(e["Last Name"]),r=e["Item Name"].replace(/ adventure|emblem|award patch/i,"")
switch(a[t]||(a[t]={}),a[t][o]||(n++,a[t][o]={adventures:[],awards:[],ranks:[]}),e["Item Type"]){case"Misc Awards":a[t][o].awards.push(r)
break
case"Badges of Rank":a[t][o].ranks.push(r)
break
default:a[t][o].adventures.push(r)}switch(e["Den Type"]){case"Lion":case"Tiger":case"Wolf":case"Bear":a[t][o].denClass=e["Den Type"].toLowerCase()
break
default:a[t][o].denClass="webelos"}}}),t.set("awardData",a),t.set("scoutCount",n),t.makePDF()}})}}})
e.default=r}),define("scoutbook-award-labels/helpers/app-version",["exports","scoutbook-award-labels/config/environment","ember-cli-app-version/utils/regexp"],function(e,a,t){function n(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o=a.default.APP.version,r=n.versionOnly||n.hideSha,l=n.shaOnly||n.hideVersion,i=null
return r&&(n.showExtended&&(i=o.match(t.versionExtendedRegExp)),i||(i=o.match(t.versionRegExp))),l&&(i=o.match(t.shaRegExp)),i?i[0]:o}Object.defineProperty(e,"__esModule",{value:!0}),e.appVersion=n,e.default=void 0
var o=Ember.Helper.helper(n)
e.default=o}),define("scoutbook-award-labels/helpers/pluralize",["exports","ember-inflector/lib/helpers/pluralize"],function(e,a){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=a.default
...
var t=a.default
e.default=t}),define("scoutbook-award-labels/initializers/app-version",["exports","ember-cli-app-version/initializer-factory","scoutbook-award-labels/config/environment"],function(e,a,t){var n,o
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0,t.default.APP&&(n=t.default.APP.name,o=t.default.APP.version)
var r={name:"App Version",initialize:(0,a.default)(n,o)}
...
t=self}var n,o=a.default.exportApplicationGlobal
n="string"==typeof o?o:Ember.String.classify(a.default.modulePrefix),t[n]||(t[n]=e,e.reopen({willDestroy:function(){this._super.apply(this,arguments),delete t[n]}}))}}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=t,e.default=void 0
...
return Object.defineProperty(t,"__esModule",{value:!0}),t}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("scoutbook-award-labels/app").default.create({name:"scoutbook-award-labels",version:"1.0.0+442153fa"})
