...
e.data.forEach(function(e){if(void 0!==e["Item Name"]){var t="".concat(e["Den Type"]," Den ").concat(e["Den Number"]),r="".concat(e["First Name"]," ").concat(e["Last Name"]),o=e["Item Name"].replace(/cub scouts\b|\badventure\b|\bemblem|award patch/i,"")
...
return Object.defineProperty(t,"__esModule",{value:!0}),t}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("scoutbook-award-labels/app").default.create({name:"scoutbook-award-labels",version:"1.0.0+b2aa4f05"})
