...
p.push(n[0]),n[1]&&p.push("       "+n[1])}),p.push(" ")}}),a.text(p,i+20,d),++o<n&&o%12==0&&(e.debug("adding a new page"),a.addPage("letter","p"),r(a,612,791,4,3))}
...
e.data.forEach(function(e){if(void 0!==e["Item Name"]){var t="".concat(e["Den Type"]," Den ").concat(e["Den Number"]),r="".concat(e["First Name"]," ").concat(e["Last Name"]),o=e["Item Name"].replace(/ adventure|emblem|award patch/i,"")
...
return Object.defineProperty(t,"__esModule",{value:!0}),t}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("scoutbook-award-labels/app").default.create({name:"scoutbook-award-labels",version:"1.0.0+f24f7d48"})
